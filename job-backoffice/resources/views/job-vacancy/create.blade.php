    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-4 pr-8">
                <!-- Back Button -->
                <x-buttons.back-button href="{{ route('job-vacancies.index') }}">Back</x-back-button>
            </div>
        </div>
    </x-slot>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900">
                        ...
                        hover:border-indigo-400">
                                    <option value="" disabled {{ old('company_id') ? '' : 'selected' }}>Select a
                                        Company</option>
                        ...
                        <div class="mb-6">
                            ...
                            @error('description') border-red-500 ring-2 ring-red-500 @enderror">{{ old('description') }}</textarea>
                        ...
                        <div class="flex justify-end space-x-2">
                            <x-buttons.back-button
                                href="{{ route('job-vacancies.index') }}">Cancel</x-buttons.back-button>
                            <x-buttons.submit-button>Save Job Vacancy</x-buttons.submit-button>
                        </div>
